            ...
            <div class="container">
                <div class="row">
                    ...
                    <!-- <div class="col-lg-4">
                        ...
                        <h4 class="double-down-line-left text-secondary position-relative pb-4 mb-4 mt-5">Featured Hostels</h4>
                        ...
                        <div class="sidebar-widget mt-5">
                            <h4 class="double-down-line-left text-secondary position-relative pb-4 mb-4">Recently Added Hostels</h4>
                            <ul class="property_list_widget">
