  ...
  <div class="header">
                ...
                <div class="header-left">
                    <a href="dashboard.php" class="logo">
						<img src="assets/img/h-hlogo.png" alt="Logo">
					</a>
					<a href="dashboard.php" class="logo logo-small">
						<img src="assets/img/h-h logo.png" alt="Logo" width="30" height="30">
					</a>
                </div>
				<!-- /Logo -->
						...
						<ul>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									...
									<li><a href="userbuilder.php"> Owners </a></li>
								</ul>
							</li>
							...
							<li class="submenu">
								<a href="#"><i class="fe fe-location"></i> <span>City & College</span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
									<li><a href="stateadd.php"> City </a></li>
									<li><a href="cityadd.php"> College </a></li>
								</ul>
							</li>
							...
							<li class="submenu">
								<a href="#"><i class="fe fe-map"></i> <span> Hostel</span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
									<li><a href="propertyadd.php"> Add Hostel</a></li>
									<li><a href="propertyview.php"> View Hostel </a></li>
