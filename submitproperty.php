...
if(isset($_POST['add']))
{
	...
	$sql="insert into property (title,pcontent,type,stype,price,location,city,state,feature,pimage,pimage1,pimage2,pimage3,pimage4,uid,status,mapimage,topmapimage,groundmapimage, isFeatured)
	values('$title','$content','$ptype','$stype','$price',
	'$loc','$city','$state','$feature','$aimage','$aimage1','$aimage2','$aimage3','$aimage4','$uid','$status','$fimage','$fimage1','$fimage2', '$isFeatured')";
    ...
    <div class="row"> 
        ...
        <div class="full-row">
            <div class="container">
                    <div class="row">
						<div class="col-lg-12">
							<h2 class="text-secondary double-down-line text-center">Submit Hostel</h2>
                        </div>
					</div>
									...
									<?php echo $msg; ?>
										...
										<div class="row">
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Specify Type</label>
													<div class="col-lg-9">
										...
										<div class="row">
											<div class="col-xl-6">
												...
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">College</label>
													<div class="col-lg-9">
														<input type="text" class="form-control" name="city" required placeholder="Enter College">
													</div>
												</div>
												<div class="form-group row">
