                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-white">B-1005, Prathamesh Excellencia, Tathawade</span> <br>
										<span class="text-white">B-1005, Prathamesh Excellencia, Tathawade</span>
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Call Us</h5>
                                        <span class="d-table text-white">+91 012345678</span>
										<span class="text-white">+91 123456789 </span>
									</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Email Adderss</h5>
										<span class="d-table text-white">helpline@hostelhunter.com</span>
										<span class="text-white">helpline@hostelhunter.com</span>
										</div>
                                </li>
                            </ul>
                        </div>
